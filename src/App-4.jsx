...
.print-status { font-weight:600; font-size:11px; color:#15161A; background:#F2F1EE; border-radius:5px; padding:1px 6px; }
...
.print-tr-table td { border-bottom:1px solid #E4E1D9; padding:7px 8px; vertical-align:top; }
...
@media print {
  .sidebar, .rail, .main-top, .btn-ghost, .btn-primary, .calc-tabs, .calc-add-btn, .calc-action-row, .ios-cal-agenda, .filter-label, .pill-group, .req-table, .transfer-list, .toolbar, .pill-group, .empty-state { display: none !important; }
