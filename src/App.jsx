...
@media print {
  .sidebar, .rail, .main-top, .btn-ghost, .btn-primary, .calc-tabs, .calc-add-btn, .calc-action-row, .ios-cal-agenda, .filter-label, .pill-group, .req-table, .transfer-table-wrap, .toolbar, .pill-group, .empty-state { display: none !important; }
