...
.sb-brand::before { content:''; display:block; width:20px; height:2px; border-radius:2px; background:#B08968; margin-bottom:8px; }
...
.quick-assign-btn { display:flex; align-items:center; gap:3px; margin-right:auto; background:#F0ECDE; border:1px solid #DED5BF; color:#2B4A5E; border-radius:999px; padding:4px 10px; font-size:11px; font-weight:700; cursor:pointer; }
...
.transfer-row { display:flex; align-items:center; gap:10px; background:#fff; border:1px solid #DED5BF; border-radius:10px; padding:10px 14px; flex-wrap:wrap; }
...
.task-driver-inline input { border:1px solid #DED5BF; border-radius:6px; padding:4px 8px; font-size:12.5px; background:#FAFAF9; }
.remove-day-btn { display:flex; align-items:center; gap:3px; background:transparent; border:1px solid #DED5BF; color:#8A8677; border-radius:6px; padding:4px 8px; font-size:11.5px; font-weight:600; cursor:pointer; }
...
@media (max-width: 560px) {
  ...
  .req-row { grid-template-columns: 1fr; background:#fff; border:1px solid #DED5BF; border-radius:9px; padding:8px; }
