          ...
          <div className="modal">
            ...
            <div className="modal-body">
              {editing.id !== "warehouse" && (
                <Field label="סוג חשבון"><PillGroup options={[{ id: "branch", label: "סניף" }, { id: "agent", label: "סוכן" }, { id: "manager", label: "הנהלה" }, { id: "driver", label: "נהג" }]} value={editing.role} onChange={(role) => setEditing({ ...editing, role })} /></Field>
              )}
              <div className="form-grid">
                ...
                <Field label="סיסמה"><input type="password" autoComplete="new-password" value={editing.password} onChange={(e) => setEditing({ ...editing, password: e.target.value })} placeholder="סיסמה" /></Field>
              </div>
