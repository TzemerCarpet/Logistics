    ...
    <div>
      ...
      <div className="task-list">
        {rejectedTasks.map((t) => (
          <div key={t.id} className="approval-row">
            <TaskCard task={t} onOpen={() => {}} />
            <div className="muted small" style={{ margin: "4px 0 6px" }}>נשלח ע״י: {t.submittedBy}</div>
            <div className="reject-note">נדחה ע״י מחסן: {t.rejectionReason || "—"}</div>
          </div>
        ))}
      </div>
...
.transfer-catalog-input { font-family:'Rubik',sans-serif; font-weight:700; color:#2B4A5E; white-space:nowrap; }
.transfer-row-name { min-width:80px; }
.transfer-row-field { font-size:14px; color:#2C2C2A; white-space:nowrap; }
